...
public class Main {
    ...
    public static void main(String[] args) {
        // Test your code here
//        Film aladdin = new Film("Aladdin");
//        Film mulan = new Film("Mulan");
//        
//        Person sam = new Person("Sam");
//        Person amy = new Person("Amy");
//        
//        RatingRegister register = new RatingRegister();
//        register.addRating(aladdin, Rating.GOOD);
//        register.addRating(mulan, Rating.FINE);
//        register.addRating(sam, mulan, Rating.NEUTRAL);
//        register.addRating(amy, aladdin, Rating.BAD);
//        
//        System.out.println(register.getRatings(aladdin));
//        System.out.println(register.getRatings(mulan));
//        System.out.println(register.getRating(sam, mulan));

//       // --------------------------------------------------------------------
        // MOOC code to test Film Comparator (46.6)
